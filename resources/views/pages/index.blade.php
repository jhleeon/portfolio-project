    ...
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Service We Provide</h3>
            </div>
            @if (count($services) > 0)
                    ...
                    @foreach ($services as $service)
                        <div class="col-md-4">
                            <span class="fa-stack fa-4x">
                                ...
                                <i class="fas <?php echo $service->icon; ?> fa-stack-1x fa-inverse"></i>
                            </span>
    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Our portfolio</h3>
            </div>
            <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">{{ $portfolio->front_title }}</div>
                                <div class="portfolio-caption-subheading text-muted">{{ $portfolio->front_sub_title }}
                                </div>
                            </div>
                        </div>
                    </div>
