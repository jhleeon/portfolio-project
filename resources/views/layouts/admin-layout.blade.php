        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.mainpage') }}">
                    <i class="fas fa-fw fa-home"></i><span>Main</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#PortfolioCollapseUtilities" aria-expanded="true"
                    aria-controls="PortfolioCollapseUtilities">
                    <i class="fas fa-fw fa-tasks"></i>
                    <span>Portfolio</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#aboutCollapseUtilities" aria-expanded="true" aria-controls="aboutCollapseUtilities">
